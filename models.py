...
class Email(BaseModel):
    ...
    gt_urgency: Optional[str] = Field(default=None, alias="_gt_urgency")
    gt_category: Optional[str] = Field(default=None, alias="_gt_category")
    gt_action: Optional[str] = Field(default=None, alias="_gt_action")
    gt_keywords: Optional[List[str]] = Field(default=None, alias="_gt_keywords")

    model_config = {"populate_by_name": True}

    @property
    def _gt_urgency(self) -> Optional[str]:
        return self.gt_urgency

    @property
    def _gt_category(self) -> Optional[str]:
        return self.gt_category

    @property
    def _gt_action(self) -> Optional[str]:
        return self.gt_action

    @property
    def _gt_keywords(self) -> Optional[List[str]]:
        return self.gt_keywords
